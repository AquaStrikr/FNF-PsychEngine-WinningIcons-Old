...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
        	['Winning Icons'],
		    ['AquaStrikr',			'aqua',				'Programmer, Credit Icons',									'https://twitter.com/aqua_strikr',		'5D5D5D'],
			['AshoXD',				'asho'				'Assistant Programmer',										'https://twitter.com/ashomoment',		'461690']
            ['Vyrox',				'vyrox',			'Compiled the Build',					'https://twitter.com/vyrox',			'FFE100'],
			[''],
			['Engine Contributors'],
