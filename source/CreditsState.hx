...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
            ['Winning Icons'],
		    ['Aqua Strikr',			'aqua',		'Coding',															'https://twitter.com/aqua_strikr',		'5D5D5D'],
			['Luis com S',			'luis',		'Additional Coding'													'https://twitter.com/Luis_comS_10', 	'FACB4A'],
			['Vyrox',				'vyrox',	'Additional Coding',												'https://twitter.com/vyrox_novo', 		'FFFC55'],
			['BeastlyGhost',		'ghost',	'Icons',															'https://twitter.com/Fan_de_RPG',		'4BD7B2'],
			[''],
			['Psych Engine Team'],
